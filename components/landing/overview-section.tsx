...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Self-host or BYO database while Rootstock anchors the proofs.',
  },
  {
    icon: Cpu,
  ...
  },
  {
    ...
    desc: 'did:rsk identifiers resolve instantly across any wallet or marketplace.',
  },
] as const
...
export default function OverviewSection() {
  return (
    <section
      id='overview'
      className='relative isolate overflow-hidden bg-muted/40 py-28'
