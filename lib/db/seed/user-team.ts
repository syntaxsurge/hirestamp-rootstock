...
export async function seedUserTeam() {
  ...
  const DEMO_CREDENTIALS = [
    ...
    {
      title: 'Hackathon Winner: HireStamp 2024',
    ...
    const PIPELINES = [
      {
        ...
        description: 'Building scalable Node.js services on HireStamp.',
      },
      {
        recruiterId: recruiterUserId,
      ...
      },
      {
        ...
        description: 'Design cost-effective, resilient cloud architectures on Rootstock.',
      },
    ]
