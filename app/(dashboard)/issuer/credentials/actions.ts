...
import { issueCredential } from '@/lib/contracts/hirestamp'
...
export const approveCredentialAction = validatedActionWithUser(
  ...
  async ({ credentialId }, _, user) => {
    ...
    const vcPayload = {
      ...
      type: ['VerifiableCredential', 'HireStampCredential'],
      issuer: issuer.did,
    ...
    return { success: 'Credential verified and NFT anchored on Rootstock.' }
  },
)
