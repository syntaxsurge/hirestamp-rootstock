...
/**
 * Mints a Rootstock DID for the connected wallet and stores it on the team.
 * – Uses wagmi so every connector (MetaMask, WalletConnect, Ledger, …) works.
 * – Prompts the wallet to switch to the Rootstock network if needed.
  ...
  async function handleClick() {
    ...
    try {
      ...
      if (chain?.id !== CHAIN_ID) {
        toast.loading('Switching to Rootstock network…', { id: toastId })
