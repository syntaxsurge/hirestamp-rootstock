...
export default function VerifyDIDPage() {
  /** Bind an RPC client to the Rootstock network defined in env */
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (!publicClient) {
      toast.error('Unsupported chain — please connect to the configured Rootstock network.')
      return
    }
    ...
    if (!addr) {
      toast.error('Enter a valid Rootstock DID or 0x address.')
      return
    }
  ...
  return (
    <PageCard
      ...
      description='Check whether a Rootstock Decentralised Identifier is registered on-chain.'
    >
      <div className='space-y-6'>
        <p className='text-sm leading-relaxed'>
          ...
          a permanent, on-chain identifier (<code className='font-mono'>did:rsk:0x…</code>). If the
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          <textarea
            ...
            placeholder='did:rsk:0x1234…  — or —  0x1234…'
          />
